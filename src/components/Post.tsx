...
export function Post({ author, publishedAt, content }: PostProps) {
    ...
    function deleteComment(commentToDelete: string) { // imutabilidade -> as variáveis não sofrem mutação ou alteração, nós criamos um novo valor (um novo espaço na memória)
